    ...
    return (
        <div>
            <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" className="sr-only peer" checked={isDark === 'dark'} onChange={() => isDark === 'dark' ? setIsDark('light') : setIsDark('dark') }/>
                    <div className="h-8 w-16  rounded-full peer-focus:outline-none bg-gradient-to-b from-[#f1a902] to-[#f5e000] dark:from-[#302ca5] dark:to-[#60aee2] shadow-inner opacity-60"></div>
