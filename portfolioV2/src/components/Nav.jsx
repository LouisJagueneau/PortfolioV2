                ...
                <div className={` ${isOpen ? 'absolute' : 'hidden'} min-h-screen w-[19rem] bg-bg-light dark:dark:bg-bg-dark top-0 right-0 z-10 transition-all duration-300`}>
                    ...
                    <div className="mx-5 mt-8">
                        <ul className="flex flex-col gap-7">
                            <div>
                                <Link to='/'><li className="text-text-muted dark:text-text-muted-dark font-poppins text-[1.0rem] flex gap-4 items-center py-3 rounded-md hover:bg-bg-ultralight dark:hover:bg-hover-bg-light-dark  cursor-pointer px-2 outline-none"> <GoHome className="text-[1.2rem]" />{t('nav.home')}</li></Link>
